...
<a  href="#" id="btn5" onclick = "changePage()">跳转</a>
         <table width="70%" border="1" id = "mytable">
	        ...
	        <s:iterator value="infoList">
	        	<tr>
	        		...
	        		<td align="center"><s:property value="infoSent"/> </td>
	        		<td align="center"><s:property value="getTime"/> </td>
	        		<td align="center"><s:property value="infoGot"/> </td>
	        		<td align="center"><s:property value="timeCost"/> </td>
	        	</tr>
	        </s:iterator>
        </table>
    ...
    <div style="position:absolute; left:1000px">
        <s:a action="info_queryAllInfo" namespace="/info">刷新</s:a>   
